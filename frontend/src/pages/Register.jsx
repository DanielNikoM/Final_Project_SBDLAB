    ...
    return (
        <div className='relative w-full h-screen bg-zinc-900/90'>
            ...
            <div className='flex justify-center items-center h-full'>
                <form onSubmit={handleRegister} className='max-w-[400px] w-full mx-auto bg-white p-8 rounded-lg'>
                    ...
                    <button className='w-full py-3 mt-4 mb-2 bg-black hover:bg-gray-500 relative text-white rounded-lg'>Register</button>
                </form>
            </div>
        </div>
    );
